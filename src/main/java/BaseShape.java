...
public abstract class BaseShape {
	...
	/**
	 * TODO FOR HOMEWORK: Write a valid constructor for a BaseShape that uses each
	 * of the following parameters Creates an instance of the BaseShape class
	 * 
	 ...
	 * @param length
	 */
	public BaseShape(String shapeName, double length) {
		this.shapeName = shapeName;
		this.length = length;
		this.height = length;
	}
	...
	// TODO FOR HOMEWORK: Create Setters for each of the above properties of
	// BaseShape and make sure the scope is correct
	/**
	 * Sets the shape name
	 * 
	...
	protected void DEBUG_PrintOutAreaAndPerimeter() {
		...
		// NOTE: The below is an unformatted string and is not fully covered in this
		// course yet. But we included it as
		// it is very helpful in printing messages to the user. Here is a resource on
		// String.format
		...
		System.out.println(String.format(unformattedPrintout, this.getShapeName(), this.getLength(), this.getHeight(),
				"area", area));
		System.out.println(String.format(unformattedPrintout, this.getShapeName(), this.getLength(), this.getHeight(),
				"perimeter", perimeter));
	}
